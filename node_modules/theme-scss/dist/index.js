...
const prog = sade('theme-scss').option('-C, --config', 'Set custom location for where your theme-config.json file is.');
prog.command('dev')
    ...
    chokidar
        ...
        .on('ready', () => {
        logger.notices.watching(`Watching ${logger.dye.yellow('src')} for CSS/SCSS changes.`);
