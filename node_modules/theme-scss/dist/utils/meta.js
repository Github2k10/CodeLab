...
export function generateBetterDiscordMeta() {
    try {
        ...
        logger.notices.error(`Your ${logger.dye.yellow('betterdiscord.json')} meta file does not exist, so a meta cannot be generated.`);
    }
    return null;
}
/**
...
export function generateUserstyleMeta() {
    try {
        ...
        logger.notices.error(`Your ${logger.dye.yellow('userstyle.json')} meta file does not exist, so a meta cannot be generated.`);
    }
    return null;
}
